import { Auction, AuctionHouseContractFunction } from '../../wrappers/sunriseAuction';
...
import { useAuctionMinBidIncPercentage } from '../../wrappers/sunriseAuction';
...
const Bid: React.FC<{
  ...
  const sunriseAuctionHouseContract = new SunriseAuctionHouseFactory().attach(
  ...
  const placeBidHandler = async () => {
    ...
    const contract = connectContractToSigner(sunriseAuctionHouseContract, undefined, library);
    const gasLimit = await contract.estimateGas.createBid(auction.sunriseId, {
      value,
    });
    placeBid(auction.sunriseId, {
      value,
